...
import { OurTargetType, PartnerOne } from "@/lib/Actions/types";

const URL = `${MarkupStoreURL}/partnersOne`;

interface Query {
  contentId?: string;
}

const GetPartnersOne = async (query?: Query): Promise<PartnerOne[]> => {
  try {
